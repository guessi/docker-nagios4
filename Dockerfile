...
ENV NAGIOS_CORE_VERSION    4.5.11
...
# ---- 2. https://github.com/nagios-plugins/nagios-plugins/blob/release-2.4.12/REQUIREMENTS
# ---- 3. https://github.com/nagios-plugins/nagios-plugins/blob/release-2.4.12/.travis.yml
