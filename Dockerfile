...
# ---- 2. https://github.com/nagios-plugins/nagios-plugins/blob/release-2.4.0/REQUIREMENTS
# ---- 3. https://github.com/nagios-plugins/nagios-plugins/blob/release-2.4.0/.travis.yml
