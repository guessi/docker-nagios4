...
# ---- 2. https://github.com/nagios-plugins/nagios-plugins/blob/release-2.4.5/REQUIREMENTS
# ---- 3. https://github.com/nagios-plugins/nagios-plugins/blob/release-2.4.5/.travis.yml
